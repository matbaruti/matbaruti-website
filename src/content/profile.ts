...
export const about = {
  ...
  story: [
    "Born on 7 July 2010 in Skopje, North Macedonia, and raised in Prishtina, Kosovo, Mat is a 16-year-old who developed an early curiosity for learning, leadership, and technology. From the beginning of his education he took initiative in both academic and extracurricular settings, and that curiosity gradually became a commitment to creating opportunities for others.",
